    ...
    <style>
        ...
        * {
        ...
        .sidebar-bottom {
            ...
            flex-shrink: 0;
            /* Prevent bottom section from shrinking */
        }
    ...
    <div id="app">
        ...
        <main class="main" id="main">
            <div class="top-row">
                ...
                <div class="app-title">Edit Sahakari Member — <?php echo htmlspecialchars($member['head_name']); ?>
                </div>
                <a href="sahakari_details.php?id=<?php echo (int) $member['id']; ?>" class="btn btn-primary-form">← Back
                    to Member</a>
            </div>
            ...
            <div class="container">
                ...
                <div id="loadingBox" class="loading">
                    <p>✏️ Updating sahakari member data...</p>
                </div>
                ...
                <form id="sahakariForm" method="POST" novalidate>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="head_email" id="head_email"
                                    value="<?php echo htmlspecialchars($member['email']); ?>" required maxlength="120"
                            ...
                            <div class="form-group">
                                <label class="checkbox-inline" style="display:flex;align-items:center;gap:8px;">
                                    <input type="checkbox" name="bulk_print_enabled" id="bulk_print_enabled" value="1"
                                        <?php echo !empty($member['bulk_print_enabled']) ? 'checked' : ''; ?>>
                                    Enable Bulk Print
                                </label>
                    ...
                    <div class="actions">
                        <div class="actions-left">
                            <a href="sahakari_details.php?id=<?php echo (int) $member['id']; ?>"
...
</html>SERVER['REQUEST_METHOD'] === 'POST') {
        die(json_encode(['success' => false, 'message' => 'Action restricted: No active subscription.']));
    } else {
        die('Action restricted: No active subscription.');
    }
}
